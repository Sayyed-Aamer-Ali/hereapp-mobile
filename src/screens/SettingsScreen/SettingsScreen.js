...
const SettingsScreen = ({ navigation }) => {
    ...
    const [emailNotification, setEmailNotification] = useState(user?.isEmailNotificationEnabled);
    const [inAppNotification, setInAppNotification] = useState(user?.isInAppNotificationEnabled);

    const toggleEmailNotification = () => setEmailNotification(previousState => !previousState);
    const toggleInAppNotification = () => setInAppNotification(previousState => !previousState);
