...
// import { AlertWithTwoButtons, Button, CountdownTimer, Header, MainLayout, ModifiedOTPInput, OtpInput } from '../../../components';
...
//         <Text style={styles.error}>You have total 3 Attempts </Text>
