  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Header title={'Location'} showBackButton={true} DrawerHeader={false} />
      </View>

      <MapComponent marker={marker} />

      <View style={styles.footerContainer}>
        <Text style={styles.footerTitle}>{name}</Text>
        <Text style={styles.footerLocation}>{location?.address}</Text>
        <Button
          text={'Go Back'}
