...
const INSTRUCTOR_START_CLASS =
  BaseUrl + 'api/attendance-management/start-attendance-with-code';
const CLASS_ATTENDANCE_STATUS =
  BaseUrl + 'api/attendance-management/check-attendance-status';
const MARKK_ATTENDANCE = BaseUrl + 'api/attendance-management/mark-attendance';
const FETCH_ATTENDANCE =
  BaseUrl + 'api/attendance-management/fetch-attendance-details';
const FETCH_ALL_MISSED_CLASSES =
...
export const API_URLS = {
  ...
  EDIT_PROFILE,
  CHANGE_PASSWORD, // User management,
  INSTRUCTOR_START_CLASS,
  CLASS_ATTENDANCE_STATUS,
  MARKK_ATTENDANCE,
  FETCH_ATTENDANCE, /// Attendance management
  FETCH_ALL_MISSED_CLASSES,
  EXCUSE_ABSENCE,
  ATTENDENCE_HISTORY,
  GET_NOTIFICATION,
  READ_NOTIFICATION,
